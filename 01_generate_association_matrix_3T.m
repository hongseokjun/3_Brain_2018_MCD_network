...
%     excluded_index = [ 37, 38, 41, 42, 71, 72, 73, 74, 75, 76, 77, 78 ];
    ...
    if(save_file)
        ...
        if(exist([ MATDIR '/07_generate_association_matrix_MCD1_3T.mat' ])~=2)
            save([ MATDIR '/07_generate_association_matrix_MCD1_3T.mat' ], ...
        ...
        if(exist([ MATDIR '/07_generate_micro_association_matrix_MCD1_3T.mat' ])~=2)
            save([ MATDIR '/01_generate_micro_association_matrix_MCD1_3T.mat' ], ...
                'micro_adjacent_matrix_control', 'micro_adjacent_matrix_FCD_Type_II', 'micro_adjacent_matrix_HET', 'micro_adjacent_matrix_PMG', ...
                'micro_zadjacent_matrix_control', 'micro_zadjacent_matrix_FCD_Type_II', 'micro_zadjacent_matrix_HET', 'micro_zadjacent_matrix_PMG', ...
                'Anatomical_Label_structs', 'Anatomical_Label_structs_idx', ...
                'micro_asso_mat_cont_res_val', 'micro_asso_mat_FCD_Type_II_res_val', 'micro_asso_mat_HET_res_val', 'micro_asso_mat_PMG_res_val', ...
                'micro_asso_mat_cont_val', 'micro_asso_mat_FCD_Type_II_val', 'micro_asso_mat_HET_val', 'micro_asso_mat_PMG_val');
        end
...
for statistical_test = 1
    ...
    for original_AAL = 1
        ...
        if(printfigs == 1)
            ...
            text(0.09, 0.91-0.5, 'F'); text(0.09, 0.805-0.5, 'C'); text(0.09, 0.745-0.5, 'P'); text(0.09, 0.67-0.5, 'O'); text(0.09, 0.6-0.5, 'L'); text(0.09, 0.54-0.5, 'T');
            text(0.04, 0.75, 'L'); text(0.04, 0.25, 'R');
            exportfigbo(gcf,[OUTPATH 'adj_diff_mat_cont_vs_FCD_Type_II_3T_3.png'], 'png', 13); close(gcf);
            ...
            exportfigbo(gcf,[OUTPATH 'brain_adj_diff_mat_cont_vs_FCD_Type_II_3T_3.png'], 'png', 13); close(gcf);
            ...
            text(0.09, 0.91-0.5, 'F'); text(0.09, 0.805-0.5, 'C'); text(0.09, 0.745-0.5, 'P'); text(0.09, 0.67-0.5, 'O'); text(0.09, 0.6-0.5, 'L'); text(0.09, 0.54-0.5, 'T');
            text(0.04, 0.75, 'L'); text(0.04, 0.25, 'R');
            exportfigbo(gcf,[OUTPATH 'adj_diff_mat_cont_vs_HET_3T_3.png'], 'png', 13); close(gcf);
            
            figure;
            [aa1, cb1] = NOELNetVisuAssociateMatrixOnSurf(diff_real_wmatrix, nodePos, (1:78), S_new, 'white', 'link_width', 1, 'link_width_weight', 'no', 'links_visible', 0.1, 'colormap', colormap_asso_mat3);
            exportfigbo(gcf,[OUTPATH 'brain_adj_diff_mat_cont_vs_HET_3T_3.png'], 'png', 13); close(gcf);
            ...
            text(0.09, 0.91-0.5, 'F'); text(0.09, 0.805-0.5, 'C'); text(0.09, 0.745-0.5, 'P'); text(0.09, 0.67-0.5, 'O'); text(0.09, 0.6-0.5, 'L'); text(0.09, 0.54-0.5, 'T');
            text(0.04, 0.75, 'L'); text(0.04, 0.25, 'R');
            exportfigbo(gcf,[OUTPATH 'adj_diff_mat_cont_vs_PMG_3T_3.png'], 'png', 13); close(gcf);
            
            figure;
            [aa1, cb1]=NOELNetVisuAssociateMatrixOnSurf(diff_real_wmatrix, nodePos, (1:78), S_new, 'white', 'link_width', 1, 'link_width_weight', 'no', 'links_visible', 0.2, 'colormap', colormap_asso_mat3);
            exportfigbo(gcf,[OUTPATH 'brain_adj_diff_mat_cont_vs_PMG_3T_3.png'], 'png', 13); close(gcf);
    ...
    for micro_AAL = 1
        ...
        if(printfigs == 1)
            ...
            spar = min(find(micro_node_fully_connected));
            FDRQ = 0.05;
            ...
            text(0.09, 0.91-0.5, 'F'); text(0.09, 0.805-0.5, 'C'); text(0.09, 0.745-0.5, 'P'); text(0.09, 0.67-0.5, 'O'); text(0.09, 0.6-0.5, 'L'); text(0.09, 0.54-0.5, 'T');
            text(0.04, 0.75, 'L'); text(0.04, 0.25, 'R');
            exportfigbo(gcf,[OUTPATH 'adj_diff_mat_cont_vs_FCD_Type_I_micro.png'], 'png', 13); close(gcf);
            ...
            exportfigbo(gcf,[OUTPATH 'brain_adj_diff_mat_cont_vs_FCD_Type_I_micro.png'], 'png', 13); close(gcf);
            ...
            text(0.09, 0.91-0.5, 'F'); text(0.09, 0.805-0.5, 'C'); text(0.09, 0.745-0.5, 'P'); text(0.09, 0.67-0.5, 'O'); text(0.09, 0.6-0.5, 'L'); text(0.09, 0.54-0.5, 'T');
            text(0.04, 0.75, 'L'); text(0.04, 0.25, 'R');
            exportfigbo(gcf,[OUTPATH 'adj_diff_mat_cont_vs_FCD_Type_II_micro.png'], 'png', 13); close(gcf);
            
            figure;
            [aa1, cb1]=NOELNetVisuAssociateMatrixOnSurf(diff_real_wmatrix, nodePos, (1:78), S_new, 'white', 'link_width', 1, 'link_width_weight', 'no', 'links_visible', 0.1, 'colormap', colormap_asso_mat3);
            exportfigbo(gcf,[OUTPATH 'brain_adj_diff_mat_cont_vs_FCD_Type_II_micro.png'], 'png', 13); close(gcf);
            ...
            text(0.09, 0.91-0.5, 'F'); text(0.09, 0.805-0.5, 'C'); text(0.09, 0.745-0.5, 'P'); text(0.09, 0.67-0.5, 'O'); text(0.09, 0.6-0.5, 'L'); text(0.09, 0.54-0.5, 'T');
            text(0.04, 0.75, 'L'); text(0.04, 0.25, 'R');
            exportfigbo(gcf,[OUTPATH 'adj_diff_mat_cont_vs_HET_micro.png'], 'png', 13); close(gcf);
            ...
            exportfigbo(gcf,[OUTPATH 'brain_adj_diff_mat_cont_vs_HET_micro.png'], 'png', 13); close(gcf);
            ...
            text(0.09, 0.91-0.5, 'F'); text(0.09, 0.805-0.5, 'C'); text(0.09, 0.745-0.5, 'P'); text(0.09, 0.67-0.5, 'O'); text(0.09, 0.6-0.5, 'L'); text(0.09, 0.54-0.5, 'T');
            text(0.04, 0.75, 'L'); text(0.04, 0.25, 'R');
            exportfigbo(gcf,[OUTPATH 'adj_diff_mat_cont_vs_PMG_micro.png'], 'png', 13); close(gcf);
            
            figure;
            [aa1, cb1]=NOELNetVisuAssociateMatrixOnSurf(diff_real_wmatrix, nodePos, (1:78), S_new, 'white', 'link_width', 1, 'link_width_weight', 'no', 'links_visible', 0.1, 'colormap', colormap_asso_mat3);
            exportfigbo(gcf,[OUTPATH 'brain_adj_diff_mat_cont_vs_PMG_micro.png'], 'png', 13); close(gcf);
