...
%        load( [ MATDIR '/03_modularity_analysis_result_MCD_maskingout_lesion.mat' ] );
        ...
        load( [ MATDIR '/07_generate_association_matrix_MCD4_3T_HET_with_NODULE.mat' ] );
        load( [ MATDIR '/08_rich_club_analysis_result_MCD4_3T_HET_with_NODULE.mat' ] );
...
for compute_rich_club = 1
    ...
    for compute_significance = 1
        ...
        for original_AAL = 1
            ...
            [ rc_FCD_Type_II rand_rc_FCD_Type_II ] = rcdiff_sparsity_parfor(asso_mat_cont_res_val, asso_mat_FCD_Type_II_res_val, myspar(1), myspar(end), interval_thres, randomization, brandnetwork, option);  figure; pause(5);
            [ rc_HET         rand_rc_HET         ] = rcdiff_sparsity_parfor(asso_mat_cont_res_val, asso_mat_HET_res_val, myspar(1), myspar(end), interval_thres, randomization, brandnetwork, option);          figure; pause(5);
            [ rc_PMG         rand_rc_PMG         ] = rcdiff_sparsity_parfor(asso_mat_cont_res_val, asso_mat_PMG_res_val, myspar(1), myspar(end), interval_thres, randomization, brandnetwork, option);          figure; pause(5);
            ...
            if(visualization == 1)
                ...
                exportfigbo(gcf,[OUTPATH 'rich_club_coefficient_3T_20idx.png'], 'png', 13); close(gcf);
        ...
        for micro_AAL = 1
            ...
            [ micro_rc_FCD_Type_I  micro_rand_rc_FCD_Type_I  ] = rcdiff_sparsity_parfor(micro_asso_mat_cont_res_val, micro_asso_mat_FCD_Type_I_res_val, myspar(1), myspar(end), interval_thres, randomization, brandnetwork, option);   figure;
            [ micro_rc_FCD_Type_II micro_rand_rc_FCD_Type_II ] = rcdiff_sparsity_parfor(micro_asso_mat_cont_res_val, micro_asso_mat_FCD_Type_II_res_val, myspar(1), myspar(end), interval_thres, randomization, brandnetwork, option);  figure;
            [ micro_rc_HET         micro_rand_rc_HET         ] = rcdiff_sparsity_parfor(micro_asso_mat_cont_res_val, micro_asso_mat_HET_res_val, myspar(1), myspar(end), interval_thres, randomization, brandnetwork, option);          figure;
            [ micro_rc_PMG         micro_rand_rc_PMG         ] = rcdiff_sparsity_parfor(micro_asso_mat_cont_res_val, micro_asso_mat_PMG_res_val, myspar(1), myspar(end), interval_thres, randomization, brandnetwork, option);          figure;
